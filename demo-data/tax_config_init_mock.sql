...
-- =========================================================
-- 1) 公司代码配置表 t_tax_company_code_config（20条）
-- =========================================================
DELETE FROM t_tax_company_code_config WHERE id BETWEEN 910001 AND 910020;
DELETE FROM t_tax_company_code_config
WHERE company_code IN (
  '2320','2355','3019','3021','3022','3023','3024','3025','3026','3027',
  '3028','3029','3030','3031','3032','3033','3034','3035','3036','3037'
);

INSERT INTO t_tax_company_code_config (
...
-- =========================================================
-- 3) 项目配置表 t_tax_project_config（20条）
--   - company_code 与 company_code_config 对齐
--   - tax_type/tax_category 与 tax_category_config 口径一致
-- =========================================================
DELETE FROM t_tax_project_config WHERE id BETWEEN 930001 AND 930020;

INSERT INTO t_tax_project_config (
...
-- =========================================================
-- 4) 增值税基础条目配置表 t_tax_vat_basic_item_config（20条）
--   - 前12条通用(NULL)
--   - 后8条为2320/2355覆盖条目
-- =========================================================
DELETE FROM t_tax_vat_basic_item_config WHERE id BETWEEN 940001 AND 940020;

INSERT INTO t_tax_vat_basic_item_config (
...
-- =========================================================
-- 5) 增值税特殊条目配置表 t_tax_vat_special_item_config（20条）
--   - 按需求仅给 2320 / 2355
-- =========================================================
DELETE FROM t_tax_vat_special_item_config WHERE id BETWEEN 950001 AND 950020;

INSERT INTO t_tax_vat_special_item_config (
