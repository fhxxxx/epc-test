...
import com.envision.extract.module.extract.domain.CompareRunDetail;
...
public abstract class InvoiceAssembler {
    ...
    @Mapping(target = "type", expression = "java(com.envision.extract.module.extract.domain.CompareTypeEnum.DATALAKECOMPARE)")
    ...
    @Mapping(target = "type", expression = "java(com.envision.extract.module.extract.domain.CompareTypeEnum.TAXBUREAUCOMPARE)")
    @Mapping(target = "status", source = "status")
    @Mapping(target = "error", source = "error")
