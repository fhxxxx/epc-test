 ...
 */
@Service
@EnableConfigurationProperties(LayoutConfig.class)
public class LayoutRemote {
    private final LayoutConfig config;
    private final RestTemplate restTemplate;

    @Autowired
    public LayoutRemote(LayoutConfig config, RestTemplate restTemplate) {
        this.config = config;
    ...
    @AvoidLog
    @Retryable
    public String runLayout(String fileUrl, Integer startPage, Integer endPage) {
