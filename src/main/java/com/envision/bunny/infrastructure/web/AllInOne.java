...
import com.envision.bunny.infrastructure.crud.ApprenticeUtil;
import com.envision.bunny.infrastructure.crud.CommonReadListener;
import com.envision.bunny.infrastructure.mybatis.AuditingEntity;
import com.envision.bunny.infrastructure.mybatis.BasicPagination;
import com.envision.bunny.infrastructure.mybatis.BasicPaging;
import com.envision.bunny.infrastructure.util.Pair;
 ...
 */
@Validated
public class AllInOne<S extends IService<E>, E extends AuditingEntity> {
    ...
    @PostMapping("/batch")
    public boolean insertBatch(@RequestBody List<E> entities) {
