...
public class ObjectOps {
    ...
    public void setRedisTemplate(RedisTemplate<String,Object> redisTemplate){
        ObjectOps.redisTemplate = redisTemplate;
    }
     ...
     *         用setRange("ds", "123456789", 3)后， redis中该value值就变为了[012123456789]
     *
     ...
     * 		   用setRange("ey", "1234", 15)后， redis中该value值就变为了[0123456789     1234]
     ...
     *
     * 示例:
     *      RedisUtil.StringOps.set("key", "a");
     *      字符串a, 转换为二进制为01100001
     *      那么getBit("key", 6)获取到的结果为false。
     *
     * @param key
     *            定位value的key
     * @param offset
