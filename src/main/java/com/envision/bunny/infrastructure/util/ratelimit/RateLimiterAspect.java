package com.envision.bunny.infrastructure.util.ratelimit;
...
public class RateLimiterAspect {
    ...
    @Pointcut("@annotation(com.envision.bunny.infrastructure.util.ratelimit.RateLimiter) || " +
            "@annotation(com.envision.bunny.infrastructure.util.ratelimit.RateLimiters)")
