...
import com.envision.bunny.infrastructure.mybatis.plugin.operation_result.DataChangeRecorderInnerInterceptor;
import com.envision.bunny.infrastructure.mybatis.plugin.operation_result.OperationResultRepository;
...
public class MyDataChangeRecorder extends DataChangeRecorderInnerInterceptor {
    ...
    protected void dealOperationResult(OperationResult operationResult) {
        ...
        final CompletableFuture<Void> completableFuture = CompletableFuture.runAsync(() -> {
            ...
            repository.save(BeanUtil.copyProperties(operationResult, com.envision.bunny.infrastructure.mybatis.plugin.operation_result.OperationResult.class));
        }, taskExecutor);
