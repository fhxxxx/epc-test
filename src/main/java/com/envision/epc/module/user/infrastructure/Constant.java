...
public class Constant {
    ...
    public static final String ALL_OA_USER_REQ_PATH_PATTERN = "/apis/it/oa/datalakeuserl2/it_oa_userlevels_l2?filter[hrstatus][EQ]=在职&fields=empno,empname,bunitno,divname,loginname,deptname,deptno,f034,hrstatus&page[limit]=5000&page[offset]=0";
