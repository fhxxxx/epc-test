...
public final class DataLakeConstants {
    ...
    public static final String FINANCE_ELECTRONICARCHIVES_CIT_QUARTER_REQ_PATH_PATTERN = "/apis/finance/electronicarchives/datalakeit_chatenv/finance_electronicarchives_accounting_document_print?filter[company_code][EQ]={}&filter[account][LIKE]=2221050000&filter[fiscal_year_period][GE]={}&filter[fiscal_year_period][LE]={}&page[offset]={}&page[limit]={}&fields=debit_amount_in_document_currency,credit_amount_in_document_currency,fiscal_year_period";
